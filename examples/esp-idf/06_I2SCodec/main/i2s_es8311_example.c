...
static esp_err_t es8311_codec_init(void)
{
    ...
    /* Create the codec control and data interfaces. */
    ...
    ESP_RETURN_ON_FALSE(ctrl_if, ESP_FAIL, TAG, "create codec control interface failed");
    ...
    ESP_RETURN_ON_FALSE(data_if, ESP_FAIL, TAG, "create codec data interface failed");

    const audio_codec_gpio_if_t *gpio_if = audio_codec_new_gpio();
    ESP_RETURN_ON_FALSE(gpio_if, ESP_FAIL, TAG, "create codec GPIO interface failed");
    ...
    ESP_RETURN_ON_FALSE(es8311_if, ESP_FAIL, TAG, "create ES8311 interface failed");
    ...
    ESP_RETURN_ON_FALSE(codec_handle, ESP_FAIL, TAG, "create codec device failed");
