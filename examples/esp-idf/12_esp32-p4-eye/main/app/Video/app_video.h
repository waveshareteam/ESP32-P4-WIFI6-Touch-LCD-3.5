 ...
 * independently releasing resources; app_video_close() performs this wait.
 *
 * @param video_fd File descriptor for the video device.
 ...
 *
 * Stops the stream if needed, closes the exact descriptor returned by
 * app_video_open(), and releases associated buffers. The descriptor must match
